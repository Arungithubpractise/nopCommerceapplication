...
public class DDLogintest extends Baseclass {
	
	Readconfig read = new Readconfig();
	
		@Test(dataProvider = "abc")
		public void DdLogintest (String email, String password) throws InterruptedException {
		...
		public  Object [][] supplydata() throws IOException, InterruptedException 
		{	
